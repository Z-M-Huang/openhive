...
Claude Agent SDK session with its own rules, skills, memory, and credentials.
...
User --> Channel (WS/Discord/CLI)
              |
              v
         Main Agent --> org-mcp (team management)
           |-- team-alpha (API dev)
...
- [Organization MCP](../../wiki/Organization-MCP) -- Control plane
