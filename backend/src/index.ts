 ...
 *
 * Key fix (Phase 0.5): Creates bridged tool handlers via MCPBridge so that
 * agents in team containers use SDK mode (not legacy child-process mode).
 * Tool calls are forwarded to root over WebSocket and responses correlated
